...
public class MealsUtil {
    public static final int CALORIE_LIMIT = 2000;

    private static final List<Meal> meals = new ArrayList<>(
            Arrays.asList(new Meal(0, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 500),
    ...
    public static void main(String[] args) {
        List<MealTo> mealsTo = filteredByStreams(meals, LocalTime.of(7, 0), LocalTime.of(12, 0), CALORIE_LIMIT);
